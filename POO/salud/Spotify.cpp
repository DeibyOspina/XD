...
list <string> Miscanciones;

void  menu(){

cout << "Menu" << endl;
cout << "1. Mostrar Lista De Canciones(Global)" << endl;
cout << "2. Mostar lista De Canciones(Propias)" << endl;
cout << "3. Agregar Cancion A Mi Lista" << endl;
cout << "4. Eliminar Cancion De Mi Lista" << endl; 
cin >> option;
...
{
    for (const auto & elemento : Miscanciones){
    cout << elemento << "";
    }
}   
 else if (option == 3) {
      ...
      cin >> cancion;
      Miscanciones.push_back(cancion);
 } else if (option == 4) {
        string cancion_elm;
